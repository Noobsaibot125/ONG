...
export const AdminDashboard: React.FC = () => {
  ...
  const saveItems = async (
    items: { page: string; section: string; key: string }[],
  ) => {
  ...
  if (loading)
    return (
      <div
        ...
        style={{ background: "linear-gradient(to bottom, #0D4A23, #1A7A3C)" }}
      >
  ...
  const StatBlock: React.FC<{
    n: number;
    defaults: { v: string; s: string; l: string };
  }> = ({ n, defaults }) => (
    <div className="bg-gray-50 rounded-[24px] border border-gray-100 p-8">
      <div className="flex items-center gap-3 mb-6">
        <span className="w-8 h-8 rounded-full bg-emerald-100 text-[#10B981] text-sm font-extrabold flex items-center justify-center">
          {n}
        </span>
      ...
      <div className="grid grid-cols-3 gap-6">
        <Field
          label="Valeur"
          value={get("accueil", "stats", `stat${n}_value`, defaults.v)}
          onChange={(v) => set("accueil", "stats", `stat${n}_value`, v)}
        />
        <Field
          label="Suffixe"
          value={get("accueil", "stats", `stat${n}_suffix`, defaults.s)}
          onChange={(v) => set("accueil", "stats", `stat${n}_suffix`, v)}
        />
        <Field
          label="Libellé"
          value={get("accueil", "stats", `stat${n}_label`, defaults.l)}
          onChange={(v) => set("accueil", "stats", `stat${n}_label`, v)}
        />
      </div>
    </div>
  );

  const showGlobalSave = ["accueil", "qsn", "actions", "contact"].includes(
    activeTab,
  );
  ...
  return (
    <div className="flex min-h-screen bg-[#F1F5F9]">
      {/* ===== SIDEBAR ===== */}
      <aside
        className="w-72 flex flex-col flex-shrink-0 min-h-screen shadow-xl z-20"
        style={{
          background:
            "linear-gradient(to bottom, #0D4A23 0%, #145C2D 40%, #1A7A3C 100%)",
        }}
      >
        {/* Brand Section */}
          ...
          <div className="max-w-3xl mx-auto space-y-6">
                ...
                >
                  <Field
                    ...
                    value={get(
                      ...
                      "hero",
                      "title",
                      "Promouvoir la Solidarité en France et en Afrique",
                    )}
                    onChange={(v) => set("accueil", "hero", "title", v)}
                  />
                  <Field
                    label="Sous-titre"
                    value={get(
                      ...
                      "hero",
                      "subtitle",
                      "Aider les veuves, les orphelins et les populations vulnérables par des actions concrètes et durables sur le terrain.",
                    )}
                    onChange={(v) => set("accueil", "hero", "subtitle", v)}
                    multiline
                    rows={3}
                  />
                  <ImageUploader
                    ...
                    onUpload={(url) => {
                      set("accueil", "hero", "image", url);
                      saveDirectValue("accueil", "hero", "image", url);
                    }}
                    token={token}
                  />
                </SectionCard>
                ...
                >
                  <Field
                    ...
                    value={get(
                      ...
                      "about",
                      "paragraph1",
                      "Fondée le 1er novembre 2017 sous la loi 1901 en France, l'ONG L'Amour Du Prochain est une organisation humanitaire présidée par M. Serge KADIO.",
                    )}
                    onChange={(v) => set("accueil", "about", "paragraph1", v)}
                    multiline
                    rows={3}
                  />
                  <Field
                    ...
                    value={get(
                      ...
                      "about",
                      "paragraph2",
                      "Nous œuvrons pour améliorer l'état de santé des populations, faciliter l'accès aux produits de première nécessité et fournir des soins médicaux de proximité en Afrique de l'Ouest.",
                    )}
                    onChange={(v) => set("accueil", "about", "paragraph2", v)}
                    multiline
                    rows={3}
                  />
                  <Field
                    ...
                    value={get(
                      ...
                      "about",
                      "quote",
                      '"Notre mission est de transformer la précarité en espoir par la solidarité active."',
                    )}
                    onChange={(v) => set("accueil", "about", "quote", v)}
                    multiline
                    rows={2}
                  />
                  <ImageUploader
                    ...
                    onUpload={(url) => {
                      set("accueil", "about", "image", url);
                      saveDirectValue("accueil", "about", "image", url);
                    }}
                    token={token}
                  />
                </SectionCard>
                ...
                >
                  ...
                  <StatBlock
                    ...
                    defaults={{
                      v: "7",
                      s: "",
                      l: "Conteneurs médicaux envoyés",
                    }}
                  />
                  <StatBlock
                    n={3}
                    defaults={{ v: "5", s: "", l: "Pays d'intervention" }}
                  />
                  <StatBlock
                    n={4}
                    defaults={{ v: "507", s: "+", l: "Bénévoles actifs" }}
                  />
                </SectionCard>
              </>
            )}
            ...
            {activeTab === "qsn" && (
              <>
                ...
                >
                  <Field
                    label="Titre"
                    value={get("qsn", "hero", "title", "Qui sommes-nous ?")}
                    onChange={(v) => set("qsn", "hero", "title", v)}
                  />
                  <Field
                    label="Sous-titre"
                    value={get(
                      ...
                      "hero",
                      "subtitle",
                      "Une organisation dévouée à l'Humain, née d'une volonté de partage et de solidarité sans frontières.",
                    )}
                    onChange={(v) => set("qsn", "hero", "subtitle", v)}
                    multiline
                    rows={2}
                  />
                  <ImageUploader
                    ...
                    onUpload={(url) => {
                      set("qsn", "hero", "image", url);
                      saveDirectValue("qsn", "hero", "image", url);
                    }}
                    token={token}
                  />
                </SectionCard>
                ...
                >
                  <Field
                    ...
                    value={get(
                      ...
                      "intro",
                      "paragraph1",
                      "L'ONG L'Amour Du Prochain a été créée le 1er novembre 2017 en France. Notre structure est régie par la loi du 1er juillet 1901 et le décret du 16 août 1901.",
                    )}
                    onChange={(v) => set("qsn", "intro", "paragraph1", v)}
                    multiline
                    rows={4}
                  />
                  <Field
                    ...
                    value={get(
                      ...
                      "intro",
                      "paragraph2",
                      "Sous la présidence de M. Serge KADIO, l'association s'est donnée pour mission principale d'apporter un soutien concret aux populations les plus démunies, avec un focus particulier sur l'Afrique de l'Ouest.",
                    )}
                    onChange={(v) => set("qsn", "intro", "paragraph2", v)}
                    multiline
                    rows={4}
                  />
                </SectionCard>
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    {(["image1", "image2", "image3"] as const).map((key, i) => (
                      <ImageUploader
                        ...
                        onUpload={(url) => {
                          set("qsn", "intro", key, url);
                          saveDirectValue("qsn", "intro", key, url);
                        }}
                        token={token}
                      />
                    ))}
                ...
                >
                  {(
                    [
                      {
                        name: "M. KADIO Kouame Serge",
                        role: "Président Fondateur",
                      },
                      {
                        name: "M. Ilo Faustin Kouadio",
                        role: "Président Fondateur",
                      },
                      {
                        name: "M. KERE Dakelgaba Charles",
                        role: "Président Fondateur",
                      },
                    ] as const
                  ).map((d, i) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <ImageUploader
                          ...
                          onUpload={(url) => {
                            set("qsn", "team", `member${n}_image`, url);
                            saveDirectValue(
                              "qsn",
                              "team",
                              `member${n}_image`,
                ...
                {(
                  [
                    {
                      title: "Santé & Médical",
                      description:
                        "L'accès aux soins est un droit fondamental. Nous collectons et acheminons du matériel médical de pointe vers les zones qui en manquent cruellement.",
                      points: [
                        "Don de lits d'hôpitaux et équipements spécialisés.",
                        "Acheminement de médicaments essentiels.",
                        "Campagnes de dépistage et de vaccination.",
                        "Soutien aux infrastructures de santé locales.",
                      ],
                    ...
                    },
                    {
                      ...
                      description:
                        "L'éducation est la clé d'un avenir meilleur. Nous fournissons des outils pour permettre aux enfants d'étudier dans de bonnes conditions.",
                      points: [
                        "Distribution de kits scolaires.",
                        "Bourses d'études pour les plus démunis.",
                    ...
                    },
                    {
                      ...
                      description:
                        "En période de crise ou dans le besoin au quotidien, nous apportons un soutien moral et matériel aux populations vulnérables.",
                      points: [
                        "Distributions alimentaires d'urgence.",
                        "Fourniture de vêtements et produits d'hygiène.",
                  ...
                  return (
                    ...
                    >
                      <Field
                        label="Titre"
                        value={get("actions", ak, "title", d.title)}
                        onChange={(v) => set("actions", ak, "title", v)}
                      />
                      <Field
                        label="Description"
                        value={get("actions", ak, "description", d.description)}
                        onChange={(v) => set("actions", ak, "description", v)}
                        multiline
                        rows={3}
                      />
                      <div>
                      ...
                      <ImageUploader
                        ...
                        onUpload={(url) => {
                          set("actions", ak, "image", url);
                          saveDirectValue("actions", ak, "image", url);
                        }}
                        token={token}
                      />
                    </SectionCard>
                ...
                <div className="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
                  <div className="px-8 py-5 border-b border-slate-100">
                    ...
                    <p className="text-xs text-slate-400 mt-0.5">
                      Renseigner les informations puis sélectionner le fichier
                    </p>
                  </div>
                ...
                <div className="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
                  <div className="px-8 py-5 border-b border-slate-100 flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xs text-slate-400 mt-0.5">
                        Toutes les images de la galerie publique
                      </p>
                    </div>
                    ...
                    {gallery.length === 0 ? (
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                        {gallery.map((img: any) => (
                          <div
                            key={img.id}
                            className="group relative rounded-xl overflow-hidden border border-slate-100 shadow-sm hover:shadow-md transition-shadow bg-white"
                          >
                            ...
                            <div className="p-3">
                              ...
                              <span className="inline-block mt-1 px-2 py-0.5 bg-slate-100 text-slate-500 text-xs rounded-md capitalize">
                                {img.category}
                              </span>
                            </div>
                          </div>
                  ...
                  <div className="col-span-2">
                    <Field
                      ...
                      value={get(
                        ...
                        "info",
                        "address",
                        "Cocody, Angré, Nelson Mandela",
                      )}
                      onChange={(v) => set("contact", "info", "address", v)}
                    />
                  </div>
                  <Field
                    label="Téléphone"
                    value={get("contact", "info", "phone", "")}
                    onChange={(v) => set("contact", "info", "phone", v)}
                  />
                  <Field
                    label="Email de contact"
                    value={get("contact", "info", "email", "")}
                    onChange={(v) => set("contact", "info", "email", v)}
                  />
                </div>
                <div className="pt-2 border-t border-slate-100">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <Field
                      ...
                      value={get("contact", "hours", "week", "08h00 - 18h00")}
                      onChange={(v) => set("contact", "hours", "week", v)}
                    />
                    <Field
                      label="Weekend (Sam – Dim)"
                      value={get("contact", "hours", "weekend", "")}
                      onChange={(v) => set("contact", "hours", "weekend", v)}
                    />
                  </div>
                </div>
              </SectionCard>
            ...
            {activeTab === "maintenance" && (
              <div className="space-y-6">
                {/* Status Card */}
                <div
                  className={`rounded-[32px] border-2 p-10 ${maintenanceEnabled ? "bg-orange-50 border-orange-300" : "bg-white border-gray-100"} shadow-sm transition-all`}
                >
                  <div className="flex items-center gap-4 mb-8">
                    <div
                      className={`p-3 rounded-2xl ${maintenanceEnabled ? "bg-orange-500" : "bg-gray-100"}`}
                    >
                      <WifiOff
                        size={28}
                        className={
                          maintenanceEnabled ? "text-white" : "text-gray-400"
                        }
                      />
                    </div>
                    <div>
                      ...
                      <p className="text-gray-500 mt-1">
                        Lorsqu'activé, les visiteurs verront une page de
                        maintenance
                      </p>
                    </div>
                  </div>
                  ...
                  {/* Toggle */}
                  <div
                    className={`flex items-center justify-between p-6 rounded-2xl border-2 mb-8 ${maintenanceEnabled ? "border-orange-300 bg-orange-100/50" : "border-gray-200 bg-gray-50"}`}
                  >
                    <div>
                      ...
                      <p
                        className={`text-sm mt-1 font-medium ${maintenanceEnabled ? "text-orange-600" : "text-gray-400"}`}
                      >
                        {maintenanceEnabled
                          ? "⚠️ Le site est actuellement inaccessible aux visiteurs"
                    ...
                    >
                      <span
                        className={`absolute top-1 left-1 w-6 h-6 bg-white rounded-full shadow transition-transform duration-300 ${maintenanceEnabled ? "translate-x-8" : "translate-x-0"}`}
                      />
                    </button>
                  </div>
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-2xl p-6 flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-blue-600 text-sm">
                      Lorsque le mode maintenance est activé, tous les visiteurs
                      verront une page indiquant que le site est en cours de
                      maintenance. Les administrateurs peuvent toujours accéder
                      au dashboard via{" "}
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-6">
          <div className="bg-white rounded-3xl shadow-2xl max-w-md w-full p-8">
            ...
            <p className="text-gray-500 text-center mb-8">
              ...
              <strong>tout le contenu personnalisé</strong> du site (textes,
              images, etc.) et restaurera les valeurs par défaut. Cette action
